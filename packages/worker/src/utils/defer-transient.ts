...
// 3 раунда retry с базовой паузой 30s + jitter до 30s даёт ~1.5-3 минуты
// общего окна на восстановление сетевой связности (DNS, transient TLS).
// После исчерпания юзер увидит «не получилось». Раньше было 5 (~2.5-5 мин) —
// на длинных outage'ах юзер ждал слишком долго placeholder'а без обратной
// связи, что хуже честного fail.
