...
/**
 * Сколько строк моделей видно в mega-menu/sheet ДО скролла. Список больше не
 * обрезается (показываем все семейства — порядок совпадает с каруселью бота),
 * но высота колонки моделей ограничена этим числом строк, дальше — скролл.
 */
